...
var bnify = vapors_1.vapors.BigNumber.from;
var blockchainData = {
    homestead: {
        addresses: [
            {
...
function equals(name, actual, expected) {
    if (expected && expected.eq) {
        ...
        expected = vapors_1.vapors.BigNumber.from(expected);
        actual = vapors_1.vapors.BigNumber.from(actual);
...
var providerFunctions = [
    {
        ...
        create: function (network) {
            if (network == "default") {
                return vapors_1.vapors.getDefaultProvider(null, ApiKeys);
            }
            return vapors_1.vapors.getDefaultProvider(network, ApiKeys);
        }
    },
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new vapors_1.vapors.providers.AlchemyProvider(null, ApiKeys.alchemy);
            }
            return new vapors_1.vapors.providers.AlchemyProvider(network, ApiKeys.alchemy);
        }
    },
    /*
    {
    ...
    */
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new vapors_1.vapors.providers.InfuraProvider(null, ApiKeys.infura);
            }
            return new vapors_1.vapors.providers.InfuraProvider(network, ApiKeys.infura);
        }
    },
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new vapors_1.vapors.providers.VaporscanProvider(null, ApiKeys.vaporscan);
            }
            return new vapors_1.vapors.providers.VaporscanProvider(network, ApiKeys.vaporscan);
        }
    },
    {
    ...
    },
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new vapors_1.vapors.providers.PocketProvider(null, ApiKeys.pocket);
            }
            return new vapors_1.vapors.providers.PocketProvider(network, ApiKeys.pocket);
        }
    },
    {
        name: "Web3Provider",
...
var fundWallet = vapors_1.vapors.Wallet.createRandom();
var testFunctions = [];
...
(function () {
    ...
    addErrorTest(vapors_1.vapors.utils.Logger.errors.NONCE_EXPIRED, function (provider) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    addErrorTest(vapors_1.vapors.utils.Logger.errors.INSUFFICIENT_FUNDS, function (provider) { return __awaiter(_this, void 0, void 0, function () {
    ...
    addErrorTest(vapors_1.vapors.utils.Logger.errors.INSUFFICIENT_FUNDS, function (provider) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            wallet = vapors_1.vapors.Wallet.createRandom().connect(provider);
    ...
    execute: function (provider) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    b0 = _a.sent();
                    assert_1.default.ok(b0.gt(vapors_1.vapors.constants.Zero), "balance is non-zero");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(300000);
                        provider = new vapors_1.vapors.providers.InfuraProvider("ropsten", ApiKeys.infura);
                        return [4 /*yield*/, vapors_1.vapors.utils.fetchJson("https://api.vapors.io/api/v1/?action=fundAccount&address=" + fundWallet.address.toLowerCase())];
                    case 1:
                        funder = _a.sent();
...
describe("Extra tests", function () {
    it("vaporscan long-request #1093", function () {
        return __awaiter(this, void 0, void 0, function () {
            var provider, value;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        provider = new vapors_1.vapors.providers.VaporscanProvider(null, ApiKeys.vaporscan);
...
describe("Test Basic Authentication", function () {
    ...
    function test(name, url) {
        it("tests " + name, function () {
            this.timeout(60000);
            return vapors_1.vapors.utils.fetchJson(url).then(function (data) {
    ...
    it("tests insecure connections fail", function () {
        ...
        assert_1.default.throws(function () {
            return vapors_1.vapors.utils.fetchJson(insecure);
        }, function (error) {
...
describe("Test API Key Formatting", function () {
    it("Infura API Key", function () {
        ...
        var apiKeyString = vapors_1.vapors.providers.InfuraProvider.getApiKey(projectId);
        ...
        var apiKeyObject = vapors_1.vapors.providers.InfuraProvider.getApiKey({
            projectId: projectId
        });
        ...
        var apiKeyObject2 = vapors_1.vapors.providers.InfuraProvider.getApiKey({
            projectId: projectId,
        ...
        assert_1.default.throws(function () {
            var apiKey = vapors_1.vapors.providers.InfuraProvider.getApiKey({
                projectId: 1234,
                projectSecret: projectSecret
            });
            console.log(apiKey);
        ...
        {
            var provider = new vapors_1.vapors.providers.InfuraProvider("homestead", {
                projectId: projectId,
                projectSecret: projectSecret
            });
        ...
        assert_1.default.throws(function () {
            var provider = new vapors_1.vapors.providers.InfuraProvider("imaginary");
    ...
    it("Pocket API key", function () {
        ...
        var apiKeyString = vapors_1.vapors.providers.PocketProvider.getApiKey(applicationId);
        ...
        var apiKeyObject = vapors_1.vapors.providers.PocketProvider.getApiKey({
        ...
        var apiKeyObject2 = vapors_1.vapors.providers.PocketProvider.getApiKey({
            applicationId: applicationId,
        ...
        assert_1.default.throws(function () {
            var apiKey = vapors_1.vapors.providers.PocketProvider.getApiKey({
                applicationId: 1234,
                applicationSecretKey: applicationSecretKey
            });
            console.log(apiKey);
        ...
        {
            var provider = new vapors_1.vapors.providers.PocketProvider("homestead", {
                applicationId: applicationId,
                applicationSecretKey: applicationSecretKey
            });
            assert_1.default.equal(provider.network.name, "homestead");
        ...
        // Attempt an unsupported network
        assert_1.default.throws(function () {
            var provider = new vapors_1.vapors.providers.PocketProvider("imaginary");
            console.log(provider);
        }, function (error) {
            return (error.argument === "network" && error.reason === "unsupported network");
        });
    ...
    it("InfuraProvider.getWebSocketProvider", function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        provider = vapors_1.vapors.providers.InfuraProvider.getWebSocketProvider();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(60000);
                        provider = new vapors_1.vapors.providers.InfuraProvider("rinkeby");
