...
var VaporscanProvider = /** @class */ (function (_super) {
    __extends(VaporscanProvider, _super);
    function VaporscanProvider(network, apiKey) {
        var _newTarget = this.constructor;
        var _this = this;
        logger.checkNew(_newTarget, VaporscanProvider);
    ...
    VaporscanProvider.prototype.detectNetwork = function () {
    ...
    VaporscanProvider.prototype.perform = function (method, params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 26:
                        ...
                        _b = parseFloat;
                        return [4 /*yield*/, get(url, null, getResult)];
                    case 27: return [2 /*return*/, _b.apply(void 0, [(_c.sent()).vapusd])];
    ...
    VaporscanProvider.prototype.getHistory = function (addressOrName, startBlock, endBlock) {
        var _this = this;
    ...
    VaporscanProvider.prototype.isCommunityResource = function () {
        return (this.apiKey === defaultApiKey);
    };
    return VaporscanProvider;
}(base_provider_1.BaseProvider));
exports.VaporscanProvider = VaporscanProvider;
//# sourceMappingURL=vaporscan-provider.js.map