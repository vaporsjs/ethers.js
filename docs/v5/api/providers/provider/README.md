...
provider.getBalance("ricmoo.firefly.vap");
// { Promise: { BigNumber: "284831012276355695" } }

// Get the code for a contract...
provider.getCode("registrar.firefly.vap");
...
provider.getStorageAt("registrar.firefly.vap", 0)
// { Promise: '0x000000000000000000000000314159265dd8dbb310642f98f50c066173c1259b' }

// Get transaction count of an account...
provider.getTransactionCount("ricmoo.firefly.vap");
// { Promise: 689 }
```
